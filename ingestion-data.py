...
def weather_data(url,transformed_data_list=[]):
    r = requests.get(url)
    data = r.json()
    #print(data)
    ...
    transformed_data = {
        ...
        "Minimum Temp (°C)": min_temp_farenheit,
   ...
   #print("transformed_data:" ,transformed_data_list)
...
def store_weather_data():
    ...
    df_data = pd.DataFrame(store_data)
    # print(df_data)
...
if __name__ =="__main__":
    ...
    for city in cities:
        ...
        weather_data(url,transformed_data_list=[])
